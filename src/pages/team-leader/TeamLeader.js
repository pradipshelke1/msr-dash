...
import ActionTeamleader from "./ActionTeamleader";
...
const TeamLeader = (props) => {
  ...
  const columns = [
    ...
    { field: "address", headerName: "Address", flex: 1 },
    {
      ...
      renderCell: (params) => {
        return <ActionTeamleader data={params.row} index={params.row.id} />;
      },
    },
  ];
  const rows = [
    ...
    <Card className="p-3 w-100">
      <CardHeader className="bg-gradient-yellow p-2 text-white">
        <div className="d-flex align-items-center justify-content-between">
          <strong className="pl-2">Team Leader Details</strong>
          <div>
            {/* {createStatus && ( */}
            <Button
